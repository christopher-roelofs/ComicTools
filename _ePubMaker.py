...
class EPubMaker(threading.Thread):
    def __init__(self, master, input_dir, file, name, publisher,wrap_pages, grayscale, max_width, max_height, progress=None):
    ...
    def write_template(self, name, *, out=None, data=None):
        ...
        data = data or {
            ...
            "images": self.images, "wrap_pages": self.wrap_pages,"creator": self.creator, "publisher": self.publisher
        }
